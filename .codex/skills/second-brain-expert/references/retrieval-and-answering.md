...
4. Read as many promising substantive notes fully as the task requires. Continue until the material concepts, explicitly named frameworks or sources, counterarguments, qualifications, and provenance are adequately covered. Prefer relevance over an arbitrary note count, while avoiding retrieval that cannot affect the answer.
...
7. Lead with the conclusion, show the strongest reasoning, include material alternatives and tensions, and cite only notes that affected the answer.

## No-result fallback

When retrieval and focused search find no note that materially informs a factual or conceptual answer, say so before giving the answer. Continue with general knowledge when it can answer the question safely, but label it as a general-knowledge answer rather than vault-grounded expertise. Label live research as an external supplement and cite it normally. Do not add irrelevant vault citations merely to make an answer appear grounded.
